...
CALL LACDYN(KLON,YDGMV_ALL(IBL),KIDIA,KFDIA,PBETADT,PDT,PSLHDA_ALL(:,IBL),&
 & PSLHDD0_ALL(:,IBL),YDGSGEOM_ALL(IBL),YDOROG_ALL(IBL),POROGL_ALL(:,IBL),&
