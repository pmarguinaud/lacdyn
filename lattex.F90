...
IF (YRLDDH%LRSIDDH) THEN
  PGMVTNDSI(KIDIA:KFDIA,1:YRDIMV%NFLEVG,YRMDDH%MSIDDH_U0)=0.0_JPRB
  PGMVTNDSI(KIDIA:KFDIA,1:YRDIMV%NFLEVG,YRMDDH%MSIDDH_V0)=0.0_JPRB
  PGMVTNDSI(KIDIA:KFDIA,1:YRDIMV%NFLEVG,YRMDDH%MSIDDH_T0)=0.0_JPRB
  DO JLEV=1,YRDIMV%NFLEVG
      PB1(KIDIA:KFDIA,YRPTRSLB1%MSLB1U9_SI+JLEV-YRDIMV%NFLSA)=0.0_JPRB
      PB1(KIDIA:KFDIA,YRPTRSLB1%MSLB1V9_SI+JLEV-YRDIMV%NFLSA)=0.0_JPRB
      PB1(KIDIA:KFDIA,YRPTRSLB1%MSLB1T9_SI+JLEV-YRDIMV%NFLSA)=0.0_JPRB
  ENDDO
  IF (LNHDYN) THEN
    PGMVTNDSI(KIDIA:KFDIA,1:YRDIMV%NFLEVG,YRMDDH%MSIDDH_PD0)=0.0_JPRB
    PGMVTNDSI(KIDIA:KFDIA,1:YRDIMV%NFLEVG,YRMDDH%MSIDDH_VD0)=0.0_JPRB
    DO JLEV=1,YRDIMV%NFLEVG
      PB1(KIDIA:KFDIA,YRPTRSLB1%MSLB1PD9_SI+JLEV-YRDIMV%NFLSA)=0.0_JPRB
      PB1(KIDIA:KFDIA,YRPTRSLB1%MSLB1VD9_SI+JLEV-YRDIMV%NFLSA)=0.0_JPRB
    ENDDO
  ENDIF
ENDIF
...
IF (LTWOTL) THEN
  ...
  CALL LATTEX_DNT(KIDIA,KFDIA,LLSETTLSW,YRDYN%NWLAG,PESGP,PESGM,&
...
IF (LTWOTL) THEN
  ...
  CALL LATTEX_DNT(KIDIA,KFDIA,LSETTLS,YRDYN%NTLAG,PESGP,PESGM, &
