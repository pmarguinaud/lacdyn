...
IF(.NOT.LTWOTL)THEN
  ALLOCATE( ZUSI9(YRDIM%NPROMA,YRDIMV%NFLEVG))
  ALLOCATE( ZVSI9(YRDIM%NPROMA,YRDIMV%NFLEVG))
  ALLOCATE( ZTSI9(YRDIM%NPROMA,YRDIMV%NFLEVG))
  IF( LNHDYN )THEN
    ALLOCATE( ZSPDSI9(YRDIM%NPROMNH,YRDIMV%NFLEVG))
    ALLOCATE( ZVWVSI9(YRDIM%NPROMNH,YRDIMV%NFLEVG))
  ENDIF
ENDIF
