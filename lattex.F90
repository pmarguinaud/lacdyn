...
IF (LTWOTL) THEN
  ...
  CALL LATTEX_DNT(KLON,KIDIA,KFDIA,LLSETTLSW,YRDYN%NWLAG,PESGP,PESGM,&
   ...
   & PGMVTNDSI(1,1,YRMDDH%MSIDDH_V0),PGMVTNDSI(1,1,YRMDDH%MSIDDH_V9),PB1(1,YRPTRSLB1%MSLB1V9_SI),KSTPT,KSTSZ,PSTACK)
...
IF (LTWOTL) THEN
  ...
  CALL LATTEX_DNT(KLON,KIDIA,KFDIA,LSETTLS,YRDYN%NTLAG,PESGP,PESGM, &
   ...
   & PGMVTNDSI(1,1,YRMDDH%MSIDDH_T0),PGMVTNDSI(1,1,YRMDDH%MSIDDH_T9),PB1(1,YRPTRSLB1%MSLB1T9_SI),KSTPT,KSTSZ,PSTACK)
