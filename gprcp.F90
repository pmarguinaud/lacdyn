SUBROUTINE GPRCP(PSTACK, KPSTSZ, KPSTPT, KLON,KIDIA,KFDIA,KFLEV,PQ,PQI,PQL,PQR,PQS,PQG,&
...
#define ZCP(i,j) PSTACK (i,IPSTPT_ZCP+j-(1))

IPSTPT_ZR = IPSTPT

IPSTPT = IPSTPT + KFLEV

#define ZR(i,j) PSTACK (i,IPSTPT_ZR+j-(1))
