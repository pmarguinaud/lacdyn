...
REAL(KIND=JPRB) :: ZREDIV (KLON)
! * computed in LASSIE or LANHSI:

REAL(KIND=JPRB) :: ZBDT (KLON)

REAL(KIND=JPRB) :: ZGAGT0M (KLON,YRDIMV%NFLEVG)
REAL(KIND=JPRB) :: ZGAGT0L (KLON,YRDIMV%NFLEVG)

REAL(KIND=JPRB) :: ZGAGT9M (KLON,YRDIMV%NFLEVG)
REAL(KIND=JPRB) :: ZGAGT9L (KLON,YRDIMV%NFLEVG)

REAL(KIND=JPRB) :: ZSDIV9 (KLON)
REAL(KIND=JPRB) :: ZSDIV0 (KLON)

REAL(KIND=JPRB) :: ZTOD9 (KLON,YRDIMV%NFLEVG)
REAL(KIND=JPRB) :: ZTOD0 (KLON,YRDIMV%NFLEVG)
