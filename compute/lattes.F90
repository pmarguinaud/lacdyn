...
REAL(KIND=JPRB) :: ZMOYSPNL_SI (KLON)
REAL(KIND=JPRB) :: ZMOYSPNL (KLON)

REAL(KIND=JPRB) :: ZSPNLT0_SI (KLON)
REAL(KIND=JPRB) :: ZSPNLT0 (KLON)

REAL(KIND=JPRB) :: ZSPNLT1_SI (KLON)
REAL(KIND=JPRB) :: ZSPNLT1 (KLON)
...
REAL(KIND=JPRB) :: ZOU (KLON,YRDIMV%NFLEVG+1)
REAL(KIND=JPRB) :: ZIN (KLON,YRDIMV%NFLEVG)
