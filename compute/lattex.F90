...
IF (LTWOTL) THEN
  ...
  CALL LATTEX_DNT(YRLDDH,YRDYN,YRDIMV,YRDIM,KLON,KIDIA,KFDIA,LLSETTLSW,YRDYN%NWLAG,PESGP,PESGM,&
   & PGMV(:,:,YDGMV%YT0%MU),PGMV(:,:,YDGMV%YT9%MU),ZMOY1U,&
   & PB2(:,YRPTRSLB2%MSLB2USI),PGMV(:,:,YDGMV%YT9%MUNL),PGMVT1(:,:,YDGMV%YT1%MU),&
   & PB1(:,YRPTRSLB1%MSLB1U0),PB1(:,YRPTRSLB1%MSLB1U9),PB1(:,YRPTRSLB1%MSLB1UF9),PGMV(:,:,YDGMV%YT9%MCUNL),&
   & PGMVTNDSI(:,:,YRMDDH%MSIDDH_U0),PGMVTNDSI(:,:,YRMDDH%MSIDDH_U9),PB1(:,YRPTRSLB1%MSLB1U9_SI))
  
  CALL LATTEX_DNT(YRLDDH,YRDYN,YRDIMV,YRDIM,KLON,KIDIA,KFDIA,LLSETTLSW,YRDYN%NWLAG,PESGP,PESGM,&
   & PGMV(:,:,YDGMV%YT0%MV),PGMV(:,:,YDGMV%YT9%MV),ZMOY1V, &
   & PB2(:,YRPTRSLB2%MSLB2VSI),PGMV(:,:,YDGMV%YT9%MVNL),PGMVT1(:,:,YDGMV%YT1%MV),&
   & PB1(:,YRPTRSLB1%MSLB1V0),PB1(:,YRPTRSLB1%MSLB1V9),PB1(:,YRPTRSLB1%MSLB1VF9),PGMV(:,:,YDGMV%YT9%MCVNL),&
   & PGMVTNDSI(:,:,YRMDDH%MSIDDH_V0),PGMVTNDSI(:,:,YRMDDH%MSIDDH_V9),PB1(:,YRPTRSLB1%MSLB1V9_SI))
...
IF (LTWOTL) THEN
  ...
  CALL LATTEX_DNT(YRLDDH,YRDYN,YRDIMV,YRDIM,KLON,KIDIA,KFDIA,LSETTLS,YRDYN%NTLAG,PESGP,PESGM, &
   & PGMV(:,:,YDGMV%YT0%MT),PGMV(:,:,YDGMV%YT9%MT),ZMOY1T,&
   & PB2(:,YRPTRSLB2%MSLB2TSI),PGMV(:,:,YDGMV%YT9%MTNL),PGMVT1(:,:,YDGMV%YT1%MT), &
   & PB1(:,YRPTRSLB1%MSLB1T0),PB1(:,YRPTRSLB1%MSLB1T9),PB1(:,YRPTRSLB1%MSLB1TF9),PGMV(:,:,YDGMV%YT9%MCTNL),&
   & PGMVTNDSI(:,:,YRMDDH%MSIDDH_T0),PGMVTNDSI(:,:,YRMDDH%MSIDDH_T9),PB1(:,YRPTRSLB1%MSLB1T9_SI))
