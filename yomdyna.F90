...
! ----------------------------------------------------------------------
!$acc declare create(NPDVAR)
!$acc declare create(NVDVAR)
!$acc declare create(ND4SYS)
!$acc declare create(LNH_PDVD)
!$acc declare create(LNH_GEOGW)
!$acc declare create(LNHX)
!$acc declare create(LNHXDER)
!$acc declare create(LGWADV)
!$acc declare create(NGWADVSI)
!$acc declare create(LRDBBC)
!$acc declare create(LGWOPT1)
!$acc declare create(LSLHD)
!$acc declare create(LSLHD_W)
!$acc declare create(LSLHD_T)
!$acc declare create(LSLHD_SPD)
!$acc declare create(LSLHD_SVD)
!$acc declare create(LSLHD_GFL)
!$acc declare create(LSLHD_OLD)
!$acc declare create(LSLHD_STATIC)
!$acc declare create(LSLHDQUAD)
!$acc declare create(LSLHDVER)
!$acc declare create(SLHDKMIN)
!$acc declare create(SLHDKMAX)
!$acc declare create(SLHDEPSH)
!$acc declare create(SLHDEPSV)
!$acc declare create(LRFRIC)
!$acc declare create(LRFRICISOTR)
!$acc declare create(LGRADSP)
!$acc declare create(LVERCOR)
!$acc declare create(LRWSDLW)
!$acc declare create(LRWSDLR)
!$acc declare create(LRWSDLR2)
!$acc declare create(LRWSDLG)
!$acc declare create(LCURVW)
!$acc declare create(NITPRHS)
!$acc declare create(RC_PD1)
!$acc declare create(L3DTURB)
!$acc declare create(LSLDIA)
!$acc declare create(LRPRSLTRJ)
!$acc declare create(LRALTVDISP)
!$acc declare create(LVSPLIP)
!$acc declare create(LCOMAD)
!$acc declare create(LCOMADH)
!$acc declare create(LCOMADV)
!$acc declare create(LCOMAD_W)
!$acc declare create(LCOMAD_T)
!$acc declare create(LCOMAD_SPD)
!$acc declare create(LCOMAD_SVD)
!$acc declare create(LCOMAD_SP)
!$acc declare create(LCOMAD_GFL)
!$acc declare create(LNESCT)
!$acc declare create(LNESCV)
!$acc declare create(LNESC)
!$acc declare create(LSETTLST)
!$acc declare create(LSETTLSV)
!$acc declare create(LSETTLS)
!$acc declare create(LELTRA)
!$acc declare create(LSLINLC1)
!$acc declare create(LSLINLC2)
!$acc declare create(LSLINL)
!$acc declare create(LAPRXPK)
!$acc declare create(NDLNPR)
!$acc declare create(RHYDR0)
!$acc declare create(LRUBC)
!$acc declare create(LPC_FULL)
!$acc declare create(LPC_CHEAP)
