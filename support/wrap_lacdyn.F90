...
REAL(KIND=JPRB)   , POINTER      :: PB1_ALL1 (:,:,:)
...
! PGMV
  ...
  YDGMV_ALL%YT0%MSPD      = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT0%MSVD      = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT1%MSPD      = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT1%MSVD      = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT1%MNHX      = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MT        = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MTL       = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MTM       = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MUNL      = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MVNL      = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MTNL      = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MSPNL     = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MSPNL_SI  = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MVCASRS   = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MRDLASR   = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MVWVNL    = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MSPDNL    = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MDIV      = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MSPD      = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MSVD      = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MNHX      = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MGW       = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MCUNL     = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MCVNL     = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MCTNL     = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MCSPNL    = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MCVWVNL   = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MCSPDNL   = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MSP       = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MSPL      = YDGMV_ALL%NDIMGMV
  YDGMV_ALL%YT9%MSPM      = YDGMV_ALL%NDIMGMV

! PB1

  ALLOCATE (PB1_ALL1 (SIZE (PB1_ALL, 1), SIZE (PB1_ALL, 2)+YRDIMV%NFLEVG+4, SIZE (PB1_ALL, 3)))
  PB1_ALL1 (:, 1:SIZE (PB1_ALL, 2), :) = PB1_ALL
  DEALLOCATE (PB1_ALL)
  PB1_ALL => PB1_ALL1


  YRPTRSLB1%MSLB1PD9    =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1VD9    =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1NHX9   =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1WRA    =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1PD0    =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1VD0    =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1UP9    =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1VP9    =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1TP9    =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1GFLP9  =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1RSSA9  =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1U9_SI  =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1V9_SI  =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1T9_SI  =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1PD9_SI =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1VD9_SI =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1C9_SI  =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1UF9    =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1VF9    =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1TF9    =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1GFLF9  =  YRPTRSLB1%NFLDSLB1 + 1
  YRPTRSLB1%MSLB1VDF9   =  YRPTRSLB1%NFLDSLB1 + 1

  YRPTRSLB1%NFLDSLB1 = YRPTRSLB1%NFLDSLB1 + YRDIMV%NFLEVG + 4
...
! PB1
  ...
  ALLOCATE (PB1_ALL1 (SIZE (PB1_ALL, 1), SIZE (PB1_ALL, 2)-YRDIMV%NFLEVG-4, SIZE (PB1_ALL, 3)))
  PB1_ALL1 = PB1_ALL (:, 1:SIZE (PB1_ALL)-YRDIMV%NFLEVG-4, :)
  DEALLOCATE (PB1_ALL)
  PB1_ALL => PB1_ALL1
