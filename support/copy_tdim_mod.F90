...
!$acc update device (YD%NPROMVC)

!$acc update device (YD%NPROMVC9)

!$acc update device (YD%NPROMDLW)

!$acc update device (YD%NPROMDLR)

!$acc update device (YD%NPROMDLR2)

!$acc update device (YD%NPROMDLG)
