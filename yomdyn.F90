...
REAL(KIND=JPRB), POINTER :: RSETTLF(:)
...
REAL(KIND=JPRB),POINTER :: RCORDIH(:)
REAL(KIND=JPRB),POINTER :: RCORDIF(:)
...
REAL(KIND=JPRB),POINTER:: SIALPH(:)
REAL(KIND=JPRB),POINTER:: SILNPR(:)
REAL(KIND=JPRB),POINTER:: SIDELP(:)
REAL(KIND=JPRB),POINTER:: SIRDEL(:)
