SUBROUTINE LATTES(YDGMV,KIDIA,KFDIA,PDTS2,PBDT,PESGP,PESGM,&
    ...
    IF (LVERTFE) THEN
      IF(YRDYN%NVLAG == 2 .OR. YRDYN%NVLAG == 3)THEN
        IF( LVFE_INTB )THEN
          ...
          ENDDO
!         CALL VERINT(YRDIM%NPROMA,KIDIA,KFDIA,YRDIMV%NFLEVG+2,YRDIMV%NFLEVG+1,YRVFE%RINTBF11,ZIN2,ZSPT1,0)
        ELSE
!         CALL VERINT(YRDIM%NPROMA,KIDIA,KFDIA,YRDIMV%NFLEVG,YRDIMV%NFLEVG+1,YRVFE%RINTE,ZSPNLT_FE,ZSPT1,0)
        ENDIF
        DO JROF=KIDIA,KFDIA
