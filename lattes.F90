SUBROUTINE LATTES(PSTACK, KPSTSZ, KPSTPT, KLON, YDGMV,KIDIA,KFDIA,PDTS2,PBDT,PESGP,PESGM,&
...
!------------------------------------------------------------------------------
REAL(KIND=JPRB) :: ZMOY1SP(KLON,YRDIMV%NFLEVG) 
REAL(KIND=JPRB) :: ZMOYSPNL(KLON),ZMOYSPNL_SI(KLON)
REAL(KIND=JPRB) :: ZSPNLT0(KLON),ZSPNLT0_SI(KLON)
REAL(KIND=JPRB) :: ZSPNLT1(KLON),ZSPNLT1_SI(KLON)
REAL(KIND=JPRB) :: ZSPNLT_FE(KLON,YRDIMV%NFLEVG)
REAL(KIND=JPRB) :: ZSPTB(KLON)
REAL(KIND=JPRB) :: ZSPT1(KLON,YRDIMV%NFLEVG+1)
REAL(KIND=JPRB) :: ZVWEI(KLON,YRDIMV%NFLEVG)
REAL(KIND=JPRB) :: ZVWEIM(KLON)
REAL(KIND=JPRB) :: ZIN(KLON,YRDIMV%NFLEVG),ZOU(KLON,YRDIMV%NFLEVG+1)
REAL(KIND=JPRB) :: ZIN2(KLON,0:YRDIMV%NFLEVG+1)
...
LOGICAL :: LLCT, LLCTC
INTEGER(KIND=JPIM) :: IPSTPT_ZIN2

INTEGER(KIND=JPIM) :: IPSTPT_ZOU

INTEGER(KIND=JPIM) :: IPSTPT_ZIN

INTEGER(KIND=JPIM) :: IPSTPT_ZVWEIM

INTEGER(KIND=JPIM) :: IPSTPT_ZVWEI

INTEGER(KIND=JPIM) :: IPSTPT_ZSPT1

INTEGER(KIND=JPIM) :: IPSTPT_ZSPTB

INTEGER(KIND=JPIM) :: IPSTPT_ZSPNLT_FE

INTEGER(KIND=JPIM) :: IPSTPT_ZSPNLT1_SI

INTEGER(KIND=JPIM) :: IPSTPT_ZSPNLT1

INTEGER(KIND=JPIM) :: IPSTPT_ZSPNLT0_SI

INTEGER(KIND=JPIM) :: IPSTPT_ZSPNLT0

INTEGER(KIND=JPIM) :: IPSTPT_ZMOYSPNL_SI

INTEGER(KIND=JPIM) :: IPSTPT_ZMOYSPNL

INTEGER(KIND=JPIM) :: IPSTPT_ZMOY1SP
...
IPSTPT_ZMOY1SP = IPSTPT

IPSTPT = IPSTPT + YRDIMV%NFLEVG

#define ZMOY1SP(i,j) PSTACK (i,IPSTPT_ZMOY1SP+j-(1))

IPSTPT_ZMOYSPNL = IPSTPT

IPSTPT = IPSTPT + 1

#define ZMOYSPNL(i) PSTACK (i,IPSTPT_ZMOYSPNL)

IPSTPT_ZMOYSPNL_SI = IPSTPT

IPSTPT = IPSTPT + 1

#define ZMOYSPNL_SI(i) PSTACK (i,IPSTPT_ZMOYSPNL_SI)

IPSTPT_ZSPNLT0 = IPSTPT

IPSTPT = IPSTPT + 1

#define ZSPNLT0(i) PSTACK (i,IPSTPT_ZSPNLT0)

IPSTPT_ZSPNLT0_SI = IPSTPT

IPSTPT = IPSTPT + 1

#define ZSPNLT0_SI(i) PSTACK (i,IPSTPT_ZSPNLT0_SI)

IPSTPT_ZSPNLT1 = IPSTPT

IPSTPT = IPSTPT + 1

#define ZSPNLT1(i) PSTACK (i,IPSTPT_ZSPNLT1)

IPSTPT_ZSPNLT1_SI = IPSTPT

IPSTPT = IPSTPT + 1

#define ZSPNLT1_SI(i) PSTACK (i,IPSTPT_ZSPNLT1_SI)

IPSTPT_ZSPNLT_FE = IPSTPT

IPSTPT = IPSTPT + YRDIMV%NFLEVG

#define ZSPNLT_FE(i,j) PSTACK (i,IPSTPT_ZSPNLT_FE+j-(1))

IPSTPT_ZSPTB = IPSTPT

IPSTPT = IPSTPT + 1

#define ZSPTB(i) PSTACK (i,IPSTPT_ZSPTB)

IPSTPT_ZSPT1 = IPSTPT

IPSTPT = IPSTPT + YRDIMV%NFLEVG+1

#define ZSPT1(i,j) PSTACK (i,IPSTPT_ZSPT1+j-(1))

IPSTPT_ZVWEI = IPSTPT

IPSTPT = IPSTPT + YRDIMV%NFLEVG

#define ZVWEI(i,j) PSTACK (i,IPSTPT_ZVWEI+j-(1))

IPSTPT_ZVWEIM = IPSTPT

IPSTPT = IPSTPT + 1

#define ZVWEIM(i) PSTACK (i,IPSTPT_ZVWEIM)

IPSTPT_ZIN = IPSTPT

IPSTPT = IPSTPT + YRDIMV%NFLEVG

#define ZIN(i,j) PSTACK (i,IPSTPT_ZIN+j-(1))

IPSTPT_ZOU = IPSTPT

IPSTPT = IPSTPT + YRDIMV%NFLEVG+1

#define ZOU(i,j) PSTACK (i,IPSTPT_ZOU+j-(1))

IPSTPT_ZIN2 = IPSTPT

IPSTPT = IPSTPT + YRDIMV%NFLEVG+1-0+1

#define ZIN2(i,j) PSTACK (i,IPSTPT_ZIN2+j-(0))
