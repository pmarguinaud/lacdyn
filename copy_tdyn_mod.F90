...
!$acc enter data create (YD%RSETTLF)
!$acc update device (YD%RSETTLF)
!$acc enter data attach (YD%RSETTLF)
...
!$acc update device (YD%RPRES_SETTLSTF)

!$acc update device (YD%RMAX_SETTLSTF)

!$acc update device (YD%REPSDYN)

!$acc update device (YD%NFLEVSF)

!$acc update device (YD%VCPR)

!$acc update device (YD%VCTR)

!$acc update device (YD%VCAK)

!$acc update device (YD%LADVFW)

!$acc update device (YD%LDRY_ECMWF)
