...
!     ------------------------------------------------------------------
!$acc declare create(JPNPST)
!$acc declare create(NCONF)
!$acc declare create(NFPOS)
!$acc declare create(LR3D)
!$acc declare create(LR2D)
!$acc declare create(LRSHW)
!$acc declare create(LRVEQ)
!$acc declare create(NOPT_MEMORY)
!$acc declare create(LALLOPR)
!$acc declare create(LFDBOP)
!$acc declare create(LECFPOS)
!$acc declare create(LGRBOP)
!$acc declare create(LFBDAP)
!$acc declare create(LARPEGEF)
!$acc declare create(LARPEGEF_TRAJHR)
!$acc declare create(LARPEGEF_TRAJBG)
!$acc declare create(LARPEGEF_RDGP_INIT)
!$acc declare create(LARPEGEF_RDGP_TRAJHR)
!$acc declare create(LARPEGEF_RDGP_TRAJBG)
!$acc declare create(CNDISPP)
!$acc declare create(CFPNCF)
!$acc declare create(CFDIRLST)
!$acc declare create(CNPPATH)
!$acc declare create(CSCRIPT_PPSERVER)
!$acc declare create(CSCRIPT_LAMRTC)
!$acc declare create(LRETCFOU)
!$acc declare create(LWRTCFOU)
!$acc declare create(LRFOUTCNORM)
!$acc declare create(LRGPTCNORM)
!$acc declare create(LNF)
!$acc declare create(LSMSSIG)
!$acc declare create(CEVENT)
!$acc declare create(CMETER)
!$acc declare create(LOPDIS)
!$acc declare create(NCYCLE)
!$acc declare create(CNMEXP)
!$acc declare create(CFCLASS)
!$acc declare create(CTYPE)
!$acc declare create(LBACKG)
!$acc declare create(LSPBSBAL)
!$acc declare create(LMINIM)
!$acc declare create(LIOLEVG)
!$acc declare create(NUNDEFLD)
!$acc declare create(LREFOUT)
!$acc declare create(LREFGEN)
!$acc declare create(LSLAG)
!$acc declare create(LTWOTL)
!$acc declare create(LREGETA)
!$acc declare create(LVFE_REGETA)
!$acc declare create(NQUAD)
!$acc declare create(LNHDYN)
!$acc declare create(LSLPHY)
!$acc declare create(N2DINI)
!$acc declare create(N3DINI)
!$acc declare create(LSPRT)
!$acc declare create(NSPPR)
!$acc declare create(NFRPOS)
!$acc declare create(NFRISP)
!$acc declare create(NFRCORM)
!$acc declare create(NFRCO)
!$acc declare create(NFRHIS)
!$acc declare create(NFRSFXHIS)
!$acc declare create(NFRMASSCON)
!$acc declare create(NFRGDI)
!$acc declare create(NFRSDI)
!$acc declare create(NFRDHFG)
!$acc declare create(NFRDHFZ)
!$acc declare create(NFRDHFD)
!$acc declare create(NFRDHP)
!$acc declare create(N6BINS)
!$acc declare create(NPOSTS)
!$acc declare create(NPOSTSMIN)
!$acc declare create(NPISPS)
!$acc declare create(NHISTS)
!$acc declare create(NHISTSMIN)
!$acc declare create(NSFXHISTS)
!$acc declare create(NSFXHISTSMIN)
!$acc declare create(NMASSCONS)
!$acc declare create(NGDITS)
!$acc declare create(NSDITS)
!$acc declare create(NDHFGTS)
!$acc declare create(NDHFZTS)
!$acc declare create(NDHFDTS)
!$acc declare create(NDHPTS)
!$acc declare create(L4DVAR)
!$acc declare create(LNOBGON)
!$acc declare create(LCANARI)
!$acc declare create(NTASKS_CANARI)
!$acc declare create(LCASIG)
!$acc declare create(LGUESS)
!$acc declare create(LOBS)
!$acc declare create(LSIMOB)
!$acc declare create(LOBSC1)
!$acc declare create(LSCREEN)
!$acc declare create(LSCREEN_OPENMP)
!$acc declare create(L_SPLIT_SCREEN)
!$acc declare create(L_SCREEN_CALL)
!$acc declare create(LMONITORING)
!$acc declare create(LOBSREF)
!$acc declare create(LIFSMIN)
!$acc declare create(LIFSTRAJ)
!$acc declare create(NCNTVAR)
!$acc declare create(LOLDPP)
!$acc declare create(NSTEPINI)
!$acc declare create(NINTERPTRAJ)
!$acc declare create(NINTERPINCR)
!$acc declare create(LINFLAT)
!$acc declare create(LINFLP9)
!$acc declare create(LINFLF1)
!$acc declare create(LECMWF)
!$acc declare create(LELAM)
!$acc declare create(LRPLANE)
!$acc declare create(LAROME)
!$acc declare create(LCALLSFX)
!$acc declare create(LSFXLSM)
!$acc declare create(LSFCFLX)
!$acc declare create(REXTSHF)
!$acc declare create(REXTLHF)
!$acc declare create(LROUGH)
!$acc declare create(REXTZ0M)
!$acc declare create(REXTZ0H)
!$acc declare create(LCOUPLO4)
!$acc declare create(LCOUPLO4_ENV)
!$acc declare create(LSFORC)
!$acc declare create(LSFORCS)
!$acc declare create(LWRSPECA_GP)
!$acc declare create(LSUSPECA_GP)
!$acc declare create(LWRSPECA_GP_UV)
!$acc declare create(LSUSPECA_GP_UV)
!$acc declare create(LGRIB_API)
