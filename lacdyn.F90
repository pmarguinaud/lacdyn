...
REAL(KIND=JPRB),ALLOCATABLE :: ZDPD0(:,:)
REAL(KIND=JPRB),ALLOCATABLE :: ZDPD9(:,:)
...
ALLOCATE( ZDPD0(YRDIM%NPROMNH,YRDIMV%NFLEVG) )
ALLOCATE( ZDPD9(YRDIM%NPROMNH,YRDIMV%NFLEVG) )
...
!*    this quantity is substracted later in GPENDTR
...
IF (ALLOCATED(ZDPD0)) DEALLOCATE(ZDPD0)
