...
REAL(KIND=JPRB) :: ZGAGT0L(KLON,YRDIMV%NFLEVG),ZGAGT0M(KLON,YRDIMV%NFLEVG)
REAL(KIND=JPRB) :: ZGAGT9L(KLON,YRDIMV%NFLEVG),ZGAGT9M(KLON,YRDIMV%NFLEVG)
REAL(KIND=JPRB) :: ZSDIV0(KLON),ZSDIV9(KLON)
REAL(KIND=JPRB) :: ZTOD0(KLON,YRDIMV%NFLEVG),ZTOD9(KLON,YRDIMV%NFLEVG)
