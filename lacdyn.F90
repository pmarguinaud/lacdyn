...
CALL LASURE(KLON,KIDIA,KFDIA,PBETADT,PDT,YDGSGEOM,&
 & ZDTS2,ZBT,LL2TLFF1,ZBDT,ZREDIV,ZESGP,ZESGM,KSTPT,KSTSZ,PSTACK)  
...
& ZSDIV0,ZSDIV9,ZTOD0,ZTOD9,ZGAGT0L,ZGAGT0M,ZGAGT9L,ZGAGT9M,KSTPT,KSTSZ,PSTACK)  
...
IF ((YRDYN%NCURRENT_ITER == 0).OR. (&
 & YRDYN%NCURRENT_ITER > 0 .AND. LPC_FULL .AND.(.NOT.LPC_CHEAP) )) THEN
  ...
  CALL LAVENT(KLON,YDGMV,KIDIA,KFDIA,KSETTLOFF,LL2TLFF1,PVCRS0,PRDLR0,ZDTS2,PRDELP0,&
            & PCTY0(1,0,YYTCTY0%M_EVEL),PATND,PGMV,PB1,PB2,PWRL95,KSTPT,KSTSZ,PSTACK)
...
CALL LATTEX(KLON,YDGMV,KIDIA,KFDIA,ZDTS2,ZBT,ZBDT,ZESGP,ZESGM,&
 ...
 & PGMV,PGMVT1,PGMVTNDSI,PB1,PB2,KSTPT,KSTSZ,PSTACK)
...
IF ((YRDYN%NCURRENT_ITER == 0).OR. (&
 & YRDYN%NCURRENT_ITER > 0 .AND. LPC_FULL .AND.(.NOT.LPC_CHEAP) )) THEN
  CALL LAVABO(KLON,KIDIA,KFDIA,LL2TLFF1,PB1,KSTPT,KSTSZ,PSTACK)
ENDIF
