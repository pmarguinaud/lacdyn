...
CALL LATTEX(PSTACK, KPSTSZ, IPSTPT, KLON,YDGMV,KIDIA,KFDIA,ZDTS2,ZBT,ZBDT,ZESGP,ZESGM,&
 & YDGSGEOM,YDOROG,POROGL,POROGM,&
...
CALL LATTES(PSTACK, KPSTSZ, IPSTPT, KLON,YDGMV,KIDIA,KFDIA,ZDTS2,ZBDT,ZESGP,ZESGM,&
